...
export async function createSuperadminWorkflowTemplate(db, userId, input: CreateTemplateInput = {}) {
...
export async function createSuperadminWorkflowRun(db, templateId, userId, input: CreateRunInput = {}) {
