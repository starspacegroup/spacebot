<script lang="ts">
	...
	const STANDARD_EMOJIS = [
		{ id: null, name: '👍', displayString: '👍', reactionString: '👍', animated: false, standard: true },
		{ id: null, name: '👎', displayString: '👎', reactionString: '👎', animated: false, standard: true },
		{ id: null, name: '❤️', displayString: '❤️', reactionString: '❤️', animated: false, standard: true },
		{ id: null, name: '😂', displayString: '😂', reactionString: '😂', animated: false, standard: true },
		{ id: null, name: '😮', displayString: '😮', reactionString: '😮', animated: false, standard: true },
		{ id: null, name: '😢', displayString: '😢', reactionString: '😢', animated: false, standard: true },
		{ id: null, name: '😡', displayString: '😡', reactionString: '😡', animated: false, standard: true },
...
<div class="emoji-selector">
	...
	<div class="selector-input-wrapper">
		{#if value && !isOpen}
			<!-- Show selected emoji -->
			<div class="selected-emoji" role="button" tabindex="0" onclick={() => isOpen = true} onkeydown={(e) => e.key === 'Enter' && (isOpen = true)}>
				...
				<button type="button" class="clear-btn" onclick={(e) => { e.stopPropagation(); clearSelection(); }} title="Clear selection">
					×
				</button>
			</div>
		{:else}
