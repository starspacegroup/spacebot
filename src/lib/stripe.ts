...
async function stripeRequest(
  ...
  endpoint: string,
  { method = "GET", body = null }: StripeRequestOptions = {},
): Promise<any> {
...
export async function createCustomer(
  platform: any,
  { guildId, guildName, email, userId }: { guildId: string; guildName: string; email?: string; userId?: string },
) {
...
export async function createCheckoutSession(
  platform: any,
  { guildId, guildName, userId, customerId, interval = "monthly", successUrl, cancelUrl }: {
    guildId: string;
    guildName: string;
    userId: string;
    customerId?: string;
