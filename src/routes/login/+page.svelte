...
<div class="login-container">
	...
	{:else if !data.isLoggedIn}
		<div class="login-card">
			...
			<p class="info">After signing in, you'll be able to:</p>
			<ul>
	...
	{#if data.isLoggedIn && data.isAdmin && !error}
		<div class="install-card">
			...
			<p class="install-info">
				Need to add SpaceBot to your server? Use the OAuth2 Code Grant flow to ensure proper
				authorization before the bot joins.
			</p>
