...
export async function POST({ request, cookies, platform }) {
	...
	const env = {
		...
		// Local Ollama gate (dev-only): routes the DM AI to a local Ollama model.
		AI_PROVIDER: getEnv('AI_PROVIDER', platform),
		OLLAMA_MODEL: getEnv('OLLAMA_MODEL', platform),
		OLLAMA_BASE_URL: getEnv('OLLAMA_BASE_URL', platform),
		DB: db,
	};
